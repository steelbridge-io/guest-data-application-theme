...
document.addEventListener("DOMContentLoaded", () => {
    ...
    table.addEventListener("input", (event) => {
        ...
        if (target.tagName === "SPAN" && target.hasAttribute("contenteditable")) {
            ...
            // phone-field-editable class). Do NOT use the field label text --
            // free-text fields whose labels mention "phone" must preserve
            // letters and punctuation when saved.
...
// Update the saveEntry function to include field_type
    const saveEntry = (entryId, fieldLabel, updatedValue, successCallback) => {
        ...
        // Only honor an explicit 'phone' field type from data-field-type.
        // Do NOT force 'phone' based on the field label containing the
        // substring "phone" -- that incorrectly matched free-text fields
        // (e.g. "... include name of hotel and phone number") and caused
        // the server to strip everything except digits.
